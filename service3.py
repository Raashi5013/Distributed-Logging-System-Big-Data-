...
def heartbeat():
    while True:
        ...
        fluentd_logger.emit("inventory_service", heartbeat_log)
        sleep(5)
...
try:
    ...
    fluentd_logger.emit("inventory_service", registration_msg)

    registry_log = generate_registry_log(status="UP")
    fluentd_logger.emit("inventory_service", registry_log)
    ...
    while True:
        ...
        fluentd_logger.emit("inventory_service", log)
        sleep(1)
